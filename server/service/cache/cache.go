...
// 	return fmt.Sprintf("bot_manager:ad_draft:%d_%d", botID, userID)
// }
...
func AdDraftConfirmCacheKey(botID, userID, updateID int64) string {
	return fmt.Sprintf("bot_manager:ad_draft_confirm:%d_%d_%d", botID, userID, updateID)
}
