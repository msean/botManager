...
<template>
  ...
  <el-input v-model="searchInfo.token" placeholder="搜索条件" />
    ...
    <el-drawer destroy-on-close :size="appStore.drawerSize" v-model="dialogFormVisible" :show-close="false" :before-close="closeDialog">
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            <el-form-item label="机器人名称:" prop="name">
    <el-input v-model="formData.name" :clearable="true" placeholder="请输入机器人名称" />
</el-form-item>
            <el-form-item label="机器人token:" prop="token">
    <el-input v-model="formData.token" :clearable="true" placeholder="请输入机器人token" />
</el-form-item>
          </el-form>
    </el-drawer>
    ...
    {{ detailForm.name }}
                    ...
                    <el-descriptions-item label="机器人token">
    {{ detailForm.token }}
</el-descriptions-item>
            </el-descriptions>
        </el-drawer>
