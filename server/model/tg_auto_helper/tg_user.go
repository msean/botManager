...
type TgUser struct {
	...
	ApiId            int    `json:"apiId" form:"apiId" gorm:"comment:apiId;column:api_id;size:256;"`                                 //apiId
	ApiHash          string `json:"apiHash" form:"apiHash" gorm:"comment:apiHash;column:api_hash;size:512;"`                         //apiHash
