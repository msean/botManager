...
func (bot_mgrApi *BotApi) CreateBot(c *gin.Context) {
	...
	err = botMgrService.CreateBot(ctx, &bot_mgr)
	if err != nil {
...
func (bot_mgrApi *BotApi) DeleteBot(c *gin.Context) {
	...
	ID := c.Query("ID")
	err := botMgrService.DeleteBot(ctx, ID)
	if err != nil {
...
func (bot_mgrApi *BotApi) DeleteBotByIds(c *gin.Context) {
	...
	err := botMgrService.DeleteBotByIds(ctx, IDs)
	if err != nil {
...
func (bot_mgrApi *BotApi) UpdateBot(c *gin.Context) {
	...
	err = botMgrService.UpdateBot(ctx, bot_mgr)
	if err != nil {
...
func (bot_mgrApi *BotApi) FindBot(c *gin.Context) {
	...
	ID := c.Query("ID")
	rebot_mgr, err := botMgrService.GetBot(ctx, ID)
	if err != nil {
...
func (bot_mgrApi *BotApi) GetBotList(c *gin.Context) {
	...
	list, total, err := botMgrService.GetBotInfoList(ctx, pageInfo)
	if err != nil {
...
func (bot_mgrApi *BotApi) GetBotPublic(c *gin.Context) {
	...
	botMgrService.GetBotPublic(ctx)
