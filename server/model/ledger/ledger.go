...
type Ledger struct {
	...
	CurrentFeeRate         float64 `json:"currentFeeRate" form:"currentFeeRate" gorm:"decimal(32,2);comment:当前费率;column:current_fee_rate"`
	IsUsdt                 int     `json:"isUsdt" form:"isUsdt" gorm:"comment:是否是usdt(1是2否);column:is_usdt;default:2"`
	CurrentCurrencyFeeRate float64 `json:"currentCurrencyFeeRate" form:"currentCurrencyFeeRate" gorm:"decimal(32,2);comment:群聊ID;column:current_currency_fee_rate;"` //当前汇率
}
